from HMC_sampler_intermediate import sampler
...
def main():
    ...
    params = {"num_leapfrog_steps":100, "step_size":0.0005}
    ...
    np.savetxt(f"data/intermediate/{algo}_{init}_delta_{delta}_train_{id}.csv", train_mse, delimiter=",")
    np.savetxt(f"data/intermediate/{algo}_{init}_delta_{delta}_test_{id}.csv", test_mse, delimiter=",")
